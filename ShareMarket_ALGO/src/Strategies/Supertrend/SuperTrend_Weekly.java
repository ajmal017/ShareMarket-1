...
public class SuperTrend_Weekly extends Connection{
	public void getData( java.sql.Connection con, String name){
		...
		try{
			...
			for(int i=2; i< tradedate.size(); i++){
				if(Integer.parseInt((supertrendReversal.get(i).toString())) == 1 && Integer.parseInt((supertrendReversal.get(i-1).toString())) == 1){
					count++;
				}else{
					if(count>200){
   ...
   public static void main(String[] args)  {
	      Test t = new Test();
	      SuperTrend_Weekly pin = new SuperTrend_Weekly();
