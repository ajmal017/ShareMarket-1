...
public class EnterAtCCIAreaIntraWithBullBearOnPrevDayWithTechnicalIndicators extends Connection{

	   public static void main(String[] args)  {
		      Test t = new Test();
		      EnterAtCCIAreaIntraWithBullBearOnPrevDayWithTechnicalIndicators range = new EnterAtCCIAreaIntraWithBullBearOnPrevDayWithTechnicalIndicators();
		      ...
		      try{
		    	  ...
		    	  Connection con = new Connection();
		    	  	...
		    	  	ResultSet rs=null;
		    	  	rs = con.executeSelectSqlQuery(dbConnection, "SELECT s.name FROM symbols s, margintables m where m.name=s.name  and volume > 1000 and s.name<>'Mindtree'  order by volume desc ");
		    	  	String name="";
	   ...
	   public void getdate(java.sql.Connection con, String name) throws SQLException{
		...
		+ " from "+name+" b, "+name+"_dp dp where b.tradedate=dp.tradedate and b.tradedate>='2016-02-01'";
		   ResultSet rs=null;
