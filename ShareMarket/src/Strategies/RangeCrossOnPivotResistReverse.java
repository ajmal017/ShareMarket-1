...
public class RangeCrossOnPivotResistReverse extends Connection{

	   public static void main(String[] args)  {
		      Test t = new Test();
		      RangeCrossOnPivotResistReverse range = new RangeCrossOnPivotResistReverse();
...
//			  				 rangeHigh > (float)pivot.get(i) && rangeHigh < (float)r1.get(i)
							if((float)high.get(i) > triggerPrice && (float)high.get(i-1) < triggerPrice && rangeHigh > (float)pivot.get(i) && rangeHigh < (float)r1.get(i)
									&& rangeLow < (float)s1.get(i) && pivotRange>1.0f){
...
//			  				&& dailyRange >2 && (int)volume.get(i)> (int)volume.get(i-1)*2
			  				...
			  				if((float)low.get(i) < triggerPrice && (float)low.get(i-1) > triggerPrice && rangeLow < (float)pivot.get(i) && rangeLow > (float)s1.get(i)
			  						&& rangeHigh > (float)r1.get(i) && pivotRange>1.0f){
