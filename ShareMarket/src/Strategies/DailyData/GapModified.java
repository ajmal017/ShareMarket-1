...
public class GapModified extends Connection{
	public void getHighDeliveryPercDates( java.sql.Connection con, String name){
		...
		List perc = new ArrayList<Float>();
	  	...
	  	GapModified gap = new GapModified();
		String date="",sql="";
...
//				if(((float)open.get(i)-(float)high.get(i-1))*100/(float)high.get(i-1) > gapPerc  && ((float)open.get(i)-(float)high.get(i-1))*100/(float)high.get(i-1) < gapLimitPerc )
				if(((float)open.get(i)-(float)close.get(i-1))*100/(float)close.get(i-1) > gapPerc  && ((float)open.get(i)-(float)close.get(i-1))*100/(float)close.get(i-1) < gapLimitPerc )
				{
...
//					if(((float)high.get(i-1)-(float)close.get(i-1))*100/(float)close.get(i-1) > 2 )
					{
...
//				if(((float)low.get(i-1)-(float)open.get(i))*100/(float)open.get(i) > gapPerc && ((float)low.get(i-1)-(float)open.get(i))*100/(float)open.get(i) < gapLimitPerc)
				if(((float)close.get(i-1)-(float)open.get(i))*100/(float)open.get(i) > gapPerc && ((float)close.get(i-1)-(float)open.get(i))*100/(float)open.get(i) < gapLimitPerc)
				{
					float trigger = ((float)open.get(i) + (float)open.get(i)*0.2f/100);
//					if(((float)open.get(i-1)==(float)low.get(i-1)))
					if(((float)close.get(i-1)-(float)open.get(i-1))*100/(float)open.get(i-1) > gapPerc)
//					if(((float)close.get(i-1)-(float)low.get(i-1))*100/(float)close.get(i-1) > 2)
					{
