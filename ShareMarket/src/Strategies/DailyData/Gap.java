...
public class Gap extends Connection{
...
//						if(percProfitAtLowPrice>targetPerc) percProfitAtLowPrice = targetPerc;
//						else percProfitAtLowPrice = (trigger - (float)close.get(i))*100/(float)trigger;
...
//						if(percProfitAtHighPrice>targetPerc) percProfitAtHighPrice = targetPerc;
//						else percProfitAtHighPrice = ((float)close.get(i)-trigger)*100/(float)trigger;
						sql = "insert into williamsresults(name, reversal, triggerPrice, profitPerc, profitRupees, date) "
